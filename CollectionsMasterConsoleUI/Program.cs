...
namespace CollectionsMasterConsoleUI
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Random numbers between 0 and 50:");
        ...
        private static void NumberChecker(List<int> numberList, int searchNumber)
        {
            ...
            {
                Console.WriteLine("The number {0} is already in the list.", searchNumber);
            }
            else
            {
                Console.WriteLine("The number {0} is not in the list.", searchNumber);
            }
        }
